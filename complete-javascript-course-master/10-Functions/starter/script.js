...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 22432463) {
    alert('Check in');
  } else {
...
lufthansa.book(239, 'Jakub Gryzio');
lufthansa.book(22, 'John Smith');
...
lufthansa.book.call(eurowings, 23, 'Werka Wozniak');
console.log(eurowings);

lufthansa.book.call(lufthansa, 200, 'Jakub Gryzio');
console.log(lufthansa);
...
lufthansa.book.call(swiss, 584, 'Mery Cooper');
console.log(swiss);
...
bookEW23('Jakub Gryzio');
bookEW23('Werka Wozniak');
...
poll.displayResults.call({ answers: [5, 2, 3, 4, 5, 6, 7, 8] }); */
